...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-md-12">
            <h3 class="page-header">Create Blog Post</h3>
        </div>
    </div>

    <form method="POST" action="{{ route('admin.blog-posts.create') }}">
        @csrf
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="form-group {{ $errors->has('slug') ? 'has-error' : '' }}">
                    ...
                    <input type="text" id="slug" name="slug" class="form-control input-sm" value="{{ old('slug') }}" placeholder="Enter slug">
                    @if($errors->has('slug'))
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="form-group {{ $errors->has('post') ? 'has-error' : '' }}">
                    ...
                    <textarea id="post" name="post" class="form-control tinymce" rows="15">{{ old('post') }}</textarea>
                    @if($errors->has('post'))

...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-md-12">
            <h3 class="page-header">Create Work</h3>
        </div>
    </div>

    <form method="POST" action="{{ route('admin.works.create') }}">
        @csrf
        ...
        <div class="row">
            <div class="col-md-4">
                <div class="form-group {{ $errors->has('chinese') ? 'has-error' : '' }}">
                    ...
                    <input type="text" id="chinese" name="chinese" class="form-control input-sm" value="{{ old('chinese') }}" placeholder="Enter work in chinese">
            ...
            <div class="col-md-4">
                <div class="form-group {{ $errors->has('english') ? 'has-error' : '' }}">
                    ...
                    <input type="text" id="english" name="english" class="form-control input-sm" value="{{ old('english') }}" placeholder="Enter work in english">
            ...
            <div class="col-md-4">
                <div class="form-group {{ $errors->has('japanese') ? 'has-error' : '' }}">
                    ...
                    <input type="text" id="japanese" name="japanese" class="form-control input-sm" value="{{ old('japanese') }}" placeholder="Enter work in japanese">
        ...
        <div class="row">
            <div class="col-md-4">
                <div class="form-group {{ $errors->has('korean') ? 'has-error' : '' }}">
                    ...
                    <input type="text" id="korean" name="korean" class="form-control input-sm" value="{{ old('korean') }}" placeholder="Enter work in korean">
            ...
            <div class="col-md-4">
                <div class="form-group {{ $errors->has('vietnamese') ? 'has-error' : '' }}">
                    ...
                    <input type="text" id="vietnamese" name="vietnamese" class="form-control input-sm" value="{{ old('vietnamese') }}" placeholder="Enter work in vietnamese">

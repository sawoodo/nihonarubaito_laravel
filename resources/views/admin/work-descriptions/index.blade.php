...
@section('title', 'Work Descriptions')
    ...
    <div class="row">
        <div class="col-md-12">
            <h3 class="page-header tw-flex tw-justify-between tw-items-center">
                Work Descriptions
                <a href="{{ route('admin.work-descriptions.create') }}" class="btn btn-sm tw-btn-emerald">
    ...
    <div class="row tw-mb-5">
        <div class="col-md-12">
            <table id="table" class="table table-bordered table-hover table-striped">
                <thead>
                    <tr>
                        <th class="col-md-1 text-center v-align-middle" rowspan="2">Work</th>
                        <th class="col-md-10 text-center v-align-middle" colspan="5">Descriptions</th>
...
@push('page-scripts')
    <script src="{{ mix('/js/backend-app-pages/admin/work_descriptions/index.js') }}"></script>
@endpush
